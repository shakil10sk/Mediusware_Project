                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr v-for="variant_price in product_variant_prices">
                                    <td>
                                        {{ variant_price.product_variant_one ? variant_price.product_variant_one : ''}}
                                        {{variant_price.product_variant_two !='' ? ' / ' + variant_price.product_variant_two : ''}}
                                        {{variant_price.product_variant_three != null ? ' / ' + variant_price.product_variant_three : ''}}
                                    </td>
                                    <td>
...
export default {
    ...
    data() {
        return {
            ...
            images: [],
            product_variant: this.existVariant,
            //  [
            //     {
            ...
            //     }
            // ],
            product_variant_prices: this.productVariant,
            dropzoneOptions: {
